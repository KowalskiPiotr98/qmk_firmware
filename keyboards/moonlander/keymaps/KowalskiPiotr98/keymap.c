...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_moonlander(
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LEFT,           KC_RGHT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC,
        ...
        LGUI, LCTL, KC_LALT, KC_LEFT, KC_RGHT,   LALT_T(KC_APP),    RCTL_T(KC_ESC),    KC_ENT,   KC_DOWN, KC_RALT, KC_RCTL, KC_ENT,
                                            KC_SPC,  MO(2), MO(1),           MO(4),  MO(3),  KC_RSFT
    ),

    [1] = LAYOUT_moonlander(
        WinSwap,    _______,   _______,   _______,   _______,   _______,   _______,           _______, _______,   _______,   _______,   _______,   _______,  _______,
        _______,    _______,   _______,   _______,   _______,   _______,   _______,           _______, KC_WH_U,   KC_WH_L,   KC_WH_R,   _______,   _______,  _______,
        _______,   _______,    KC_BTN3,   KC_BTN2,   KC_BTN1,   _______,   _______,           _______, KC_MS_L,   KC_MS_D,   KC_MS_U,   KC_MS_R,   _______,  _______,
